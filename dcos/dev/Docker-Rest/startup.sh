...
java -Dtarget-host-to-proxy=http://93a256a7.cdn.cms.movetv.com -DindexingHost=data.marathon.l4lb.thisdcos.directory -DindexingPort=9200 -jar /sports-cloud-rest-server.jar localhost 9080 
