...
BASE_PRIVATE_HOSTED_DOMAIN="sports-cloud.com" ARTIFACT_SERVER_NAME="artifact-server" DOCKER_REGISTRY_NAME="registry" CLUSTER_NAME="slingtv-sports-cloud.k8s.local" ./build.sh slingtv-sports-cloud
